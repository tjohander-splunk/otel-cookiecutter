# Substitute {{ cookiecutter.realm }} and {{ cookiecutter.token }}
...
jaeger_exporter = JaegerExporter(
    collector_endpoint="https://ingest.{{ cookiecutter.realm }}.signalfx.com/v2/trace",
    username="auth",
    password="{{ cookiecutter.token }}"
)
